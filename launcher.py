...
def main(): #the main that have all other functions called
    ...
    while looping: #while looping is true
        ...
        if optionchoose == 1: #if user selected 1 
            ...
            idate = input(" Enter your product Expire date in format dd/MM/yyyy: ") #get the expire date
            ...
            idate = input(" Enter expiry date in format dd/MM/yyyy: ") #get the expiry date
...
if os.path.isfile(oldfile): #extra step if we want old data from warehouse items 
    print("!! !! There's an old data file would you like to restore it ? !! !!  \n")
